(function() {
  ...
  Wappo.Cell = function(row, col) {
    ...
    this.rowIndex = row; // Индекс строки ячейки в массиве ячеек. Может быть изменен +-1 относительно home за пределами поля.
    this.colIndex = col; // Индекс строки ячейки в массиве ячеек. Может быть изменен +-1 относительно home за пределами поля.
